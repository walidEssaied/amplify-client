...
export const HeroServicesPage: FC = () => {
  ...
  return (
    <>
      <section
        ref={parallaxRef}
        className="relative  flex flex-col justify-center overflow-hidden bg-white dark:bg-black"
        style={{
          backgroundSize: "cover",
          backgroundPosition: "center",
          boxShadow: `
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 h-40 bg-gradient-to-b from-white hidden dark:block dark:from-black to-transparent z-10"></div>
        <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-white hidden dark:block dark:from-black to-transparent z-10"></div>

        <div className="container relative z-20 py-20 md:py-32 space-y-6 text-black dark:text-white flex flex-col items-center justify-center">
          <div className="relative w-3/4">
            <div className="relative w-full h-full">
              <div
                className="absolute -inset-8 bg-white dark:bg-black rounded-[40px] z-0 pointer-events-none"
                style={{
                  boxShadow: `
      ...
      <RatingCard
        title={
          <div className="text-center leading-snug" data-aos="fade-up">
        ...
        buttons={
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 w-full sm:w-auto">
            <Button className="w-full sm:w-auto  text-white bg-primary">
              Contact Us Now
            </Button>
            <Button
              className={`w-full sm:w-auto ${buttonVariants({
                variant: "outline",
              })} bg-[#3F3F3F] text-white hover:bg-[#4F4F4F] dark:bg-white dark:text-black dark:hover:bg-gray-200`}
            >
              What You Will Get
            </Button>
          </div>
...
export const MarketingSection: FC = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white p-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[1, 2, 3].map((item) => (
              <div
                key={item}
                className="bg-gray-100 dark:bg-zinc-900/50 rounded-2xl p-10 border border-gray-300 dark:border-gray-600 backdrop-blur-sm"
              >
        ...
        <p className="text-center text-gray-600 dark:text-gray-400 mb-16 font-bold text-xl">
        ...
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div
                key={item}
                className="bg-gray-100 dark:bg-zinc-900/50 rounded-2xl p-10 backdrop-blur-sm flex flex-col gap-10 border border-gray-300 dark:border-gray-600"
              >
                <div className="flex flex-col gap-4">
                  <div className="w-12 h-12">
                    <img
                      src={GrowthIcon}
                      className="p-2 border rounded-md bg-black dark:bg-transparent"
                      alt="Growth Icon"
                    />
                  </div>
